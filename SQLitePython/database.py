...
class Widget(QWidget):
    def __init__(self):
        ...
        button_update_data.clicked.connect(self.update_data) # generated error
        ...
        # Display all elements vertically 7:28
        layout = QVBoxLayout()
